...
export const TEXT = {
  en: {
    ...
    shareMainMsg: (name: string) => `📖 I'm preserving a story about ${name} on VitaMyStory.`,
  ...
  es: {
    ...
    shareMainMsg: (name: string) => `📖 Estoy guardando una historia sobre ${name} en VitaMyStory.`,

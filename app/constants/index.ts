...
export const TEXT = {
  en: {
    ...
    aiQuestionsTitle: "AI-Powered Questions",
    aiQuestionsSubtitle: "Unlock personalized questions based on your stories",
  ...
  es: {
    ...
    aiQuestionsTitle: "Preguntas con IA",
    aiQuestionsSubtitle: "Desbloquea preguntas personalizadas basadas en tus historias",
